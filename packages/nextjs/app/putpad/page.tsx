  ...
  return (
    <>
      <div className="px-5 sm:px-7 md:px-20 my-10">
        <h3 className="text-7xl text-center font-montserrat-classic text-blue-600">Putpad</h3>

        <p className="text-center text-2xl mt-10 mb-14">
          Check out all the items on Putpad
        </p>
